...
/** Responsive, format-optimized hero background sources (generated by
 *  scripts/optimize-hero-images.mjs). Order of preference: avif → webp →
 *  fallback (jpg/png). Mobile variants are downscaled (~860px wide). */
...
export interface CollegeData {
   ...
   *  Kept as the simple single-path fallback; `hero.backgroundImage` holds the
   *  responsive, format-optimized sources used by the <picture> element. */
  heroImage: string;
  hero: HeroData;
  nav: NavLink[];
...
export const college: CollegeData = {
  ...
  hero: {
    ...
    backgroundImage: {
      ...
      fallback: "/images/campus/crescent-campus-hero-bg.png",
      mobileAvif: "/images/campus/crescent-campus-hero-bg-mobile.avif",
      mobileWebp: "/images/campus/crescent-campus-hero-bg-mobile.webp",
      mobileFallback: "/images/campus/crescent-campus-hero-bg-mobile.jpg",
    },
  },
